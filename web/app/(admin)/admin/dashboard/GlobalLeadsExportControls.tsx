// web/app/(admin)/admin/dashboard/GlobalLeadsExportControls.tsx
'use client';
...
export default function GlobalLeadsExportControls() {
  ...
  const handleQuickRange = (range: 'all' | 'last7' | 'thisMonth') => {
    setError(null);
  ...
  return (
    <section className="mt-8 rounded-lg border border-gray-200 bg-white p-4 shadow-sm">
      <h2 className="mb-2 text-lg font-semibold">Leads exportieren (global)</h2>
      <p className="mb-4 text-sm text-gray-600">
        Exportiere alle Leads über alle Events hinweg als CSV. Du kannst einen
        Zeitraum wählen oder einen Schnellfilter verwenden.
      </p>
